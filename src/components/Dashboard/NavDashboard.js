      ...
      <div className="row">
        <div className="col-12">
          <nav id="navDashboard" className="nav d-flex flex-row justify-content-center mx-auto nav-pills">
            <NavLink activeClassName="active" className="text-center nav-link d-flex flex-column book " to='/dashboard/aboutme'>
              <figure>
            ...
            <NavLink activeClassName="active" className="text-center d-flex flex-column book" to='/dashboard/publications'>
              <figure>
            ...
            <NavLink activeClassName="active" to="/dashboard/experiences" className="text-center nav-link d-flex flex-column experience">
              <figure>
