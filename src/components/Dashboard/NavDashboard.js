      ...
      <div className="row">
        <div className="col-12">
          <nav id="navDashboard" className="nav d-flex flex-row justify-content-center mx-auto nav-pills">
            <a className="text-center nav-link d-flex flex-column information active" href="/user_test/information/">
              <figure>
            ...
            <a className="text-center nav-link d-flex flex-column book " href="/user_test/publications/">
              <figure>
            ...
            <a className="text-center nav-link d-flex flex-column experience">
              <figure>
